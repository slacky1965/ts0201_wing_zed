...
Есть небольшой нюанс с температурой. Нормально этот экран может вывести температуру в диапазоне -9.9°C...+199.9. Если температура выходит за пределы этого диапазона, то на экране будет надпись `Er`. При этом в сеть будет уходить реальная температура.
...
- 1.0.02
	...
	- Некоторые макросы убраны в скобки.
