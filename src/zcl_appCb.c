...
#ifdef ZCL_IDENTIFY
/*********************************************************************
 * @fn      app_zclIdentifyTimerCb
 *
 * @brief   Timer callback to decrement identify time
 *
 * @param   arg - pointer to user data (unused)
 *
 * @return  0 to continue timer, -1 to stop
 */
...
/*********************************************************************
 * @fn      app_zclIdentifyTimerStop
 *
 * @brief   Stop the identify timer event
 *
 * @param   None
 *
 * @return  None
...
static status_t leak_zclIasZoneInitNormalOperationModeCmdHandler(void) {
    ...
    uint8_t status = ZCL_STA_FAILURE;
 ...
 * @return  status_t
 */
status_t leak_iasZoneCb(zclIncomingAddrInfo_t *pAddrInfo, uint8_t cmdId, void *cmdPayload)
{
...
/*********************************************************************
 * @fn      app_zclCheckInCmdSend
 *
 * @brief   Send a ZCL Poll Control check-in command
 *
 * @param   None
 *
 * @return  None
...
/*********************************************************************
 * @fn      app_zclCheckInTimerCb
 *
 * @brief   Timer callback for periodic check-in command
 *
 * @param   arg - pointer to user data (unused)
 *
 * @return  0 to continue timer, -1 to stop
...
/*********************************************************************
 * @fn      app_zclCheckInStart
 *
 * @brief   Start the periodic check-in timer if binding exists
 *
 * @param   None
 *
 * @return  None
...
/*********************************************************************
 * @fn      app_zclSetFastPollMode
 *
 * @brief   Set fast poll mode on or off
 *
 * @param   fastPollMode - true to enable fast poll, false for normal poll
 *
 * @return  None
 */
...
/*********************************************************************
 * @fn      app_zclFastPollTimeoutCb
 *
 * @brief   Timer callback when fast poll mode timeout expires
 *
 * @param   arg - pointer to user data (unused)
 *
...
/*********************************************************************
 * @fn      app_zclPollCtrlChkInRspCmdHandler
 *
 * @brief   Handler for ZCL Poll Control check-in response command
 *
 * @param   pCmd - pointer to the check-in response command payload
 *
 * @return  status_t
 */
...
/*********************************************************************
 * @fn      app_zclPollCtrlFastPollStopCmdHandler
 *
 * @brief   Handler for ZCL Poll Control fast poll stop command
 *
 * @param   None
 *
 * @return  status_t
...
/*********************************************************************
 * @fn      app_zclPollCtrlSetLongPollIntervalCmdHandler
 *
 * @brief   Handler for ZCL Poll Control set long poll interval command
 *
 * @param   pCmd - pointer to the set long poll interval command payload
 *
 * @return  status_t
 */
...
/*********************************************************************
 * @fn      app_zclPollCtrlSetShortPollIntervalCmdHandler
 *
 * @brief   Handler for ZCL Poll Control set short poll interval command
 *
 * @param   pCmd - pointer to the set short poll interval command payload
 *
 * @return  status_t
 */
